...
pub struct I18n {
    ...
    pub prov_claude: &'static str,
    pub prov_deepseek: &'static str,
    pub prov_deepl: &'static str,
    pub prov_lmstudio: &'static str,
    pub prov_azure: &'static str,
    pub azure_deployment_name: &'static str,
    pub azure_api_version: &'static str,
    ...
    pub txt_ocr_cleaning: &'static str,
    ...
    pub yolo_full_page_hybrid: &'static str,
    ...
    pub capture_gdi: &'static str,
    pub capture_dxgi: &'static str,
    pub capture_wgc: &'static str,
...
const EN: I18n = I18n {
    ...
    tab_general: "General",
    tab_ai_provider: "AI Provider & API",
    tab_translation_behavior: "Translation Style",
    tab_performance: "Performance Tuning",
    tab_ocr: "OCR System",
    tab_text_processing: "Text Cleaning",
    tab_image_processing: "Image Processing",
    tab_custom_rules: "Dictionary & Rules",
    tab_overlay: "Display Settings",
    ...
    prov_claude: "Claude (Anthropic)",
    prov_deepseek: "DeepSeek API",
    prov_deepl: "DeepL Translate",
    prov_lmstudio: "LM Studio (Local LLM)",
    prov_azure: "Azure OpenAI",
    ...
    txt_lang_spec: "Language-Specific Processing",
    txt_ocr_cleaning: "OCR Cleaning Filters",
    ...
    yolo_full_page_hybrid: "YOLO + Full Page (Hybrid) - Accurate text detection grouped by YOLO",
    dbg_telemetry: "Advanced Pipeline Telemetry",
    capture_section: "Capture",
    capture_method: "Capture Engine",
    capture_gdi: "Windows GDI (Standard, High Compatibility)",
    capture_dxgi: "Windows DXGI (Desktop Duplication API, High Performance)",
    capture_wgc: "Windows Graphics Capture (Modern Windows 10+, Borderless Support)",
    offline: "Offline",
...
const TH: I18n = I18n {
    ...
    smart_merge: "ผสานประโยคอัจฉริยะ (แก้ปัญหาประโยคขาดช่วง)",
    region: "พื้นที่",
    active: "ทำงานอยู่",
    select_area: "เลือกพื้นที่",
    screen: "หน้าจอ",
    refresh: "อัตราการจับภาพ",
    from: "จาก",
    to: "เป็น",
    show_frame: "แสดงกรอบ",
    ...
    tab_general: "ทั่วไป",
    tab_ai_provider: "เชื่อมต่อ AI & API",
    tab_translation_behavior: "สไตล์การแปล",
    tab_performance: "ปรับแต่งประสิทธิภาพ",
    tab_ocr: "ระบบอ่านข้อความ (OCR)",
    tab_text_processing: "ล้างข้อความขยะ",
    tab_image_processing: "การปรับแต่งภาพ (Pre-OCR)",
    tab_custom_rules: "พจนานุกรมส่วนตัว",
    tab_overlay: "ตั้งค่าการแสดงผล",
    ...
    prov_deepseek: "DeepSeek API",
    prov_deepl: "DeepL Translate",
    prov_lmstudio: "LM Studio (รันบนเครื่อง Local)",
    prov_azure: "Azure OpenAI",
    azure_deployment_name: "ชื่อ Deployment (Deployment Name)",
    azure_api_version: "เวอร์ชัน API (เช่น 2024-02-01)",
    ...
    txt_ocr_cleaning: "ตัวกรองความสะอาดข้อความ OCR",
    ...
    yolo_full_page_hybrid: "YOLO + Full Page (Hybrid) - สแกนเต็มหน้าจอและจับกลุ่มด้วย YOLO (ดีที่สุด)",
    dbg_telemetry: "ข้อมูลสถานะเชิงลึกของระบบ",
    capture_section: "การจับภาพหน้าจอ",
    capture_method: "ระบบที่ใช้จับภาพ (Engine)",
    capture_gdi: "Windows GDI (แบบมาตรฐาน, เสถียรสูง)",
    capture_dxgi: "Windows DXGI (ดึงจาก GPU, ประสิทธิภาพสูง)",
    capture_wgc: "Windows Graphics Capture (ระบบใหม่ Windows 10+)",
    offline: "ออฟไลน์",
