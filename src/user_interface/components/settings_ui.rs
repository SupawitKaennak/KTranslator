...
fn render_tab_general(
    ...
    section_header(ui, i18n.ui_language);
...
fn render_tab_ocr(
    ...
    if *engine_ref == crate::infrastructure::settings::OcrEngineType::MangaOCR {
        ...
        if download_progress.is_downloading {
            ...
            let models_exist = check_file_exists(enc_p)
                && check_file_exists(dec_p)
                && check_file_exists(tok_p)
                && check_file_exists(yolo_p);
...
// ─────────────────────────────────────────────
fn render_tab_translation_behavior(
    ui: &mut egui::Ui,
    settings: &mut Settings,
    i18n: &crate::user_interface::i18n::I18n,
) {
...
// Tab: Debugging Panel
// ─────────────────────────────────────────────
fn render_tab_debugging(
    ui: &mut egui::Ui,
    debug_infos: &[SlotDebugInfo],
    i18n: &crate::user_interface::i18n::I18n,
) {
