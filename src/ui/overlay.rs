                    ...
                    if show_overlay {
                        ...
                        if has_positions {
                            ...
                            while idx < ocr_lines.len() {
                                ...
                                let chunks = crate::core::usecases::formatter::TextFormatter::create_chunks(&trans, block_lines.len());
                                ...
                                if block_lines.len() > 1 {
                                    ...
                                    if let Some(bg_rect) = union_rect {
                                        ...
                                        let full_text = crate::core::usecases::formatter::TextFormatter::wrap_thai_text(&raw_text);
                                    ...
                                    for (i, line) in block_lines.iter().enumerate() {
                                        ...
                                        let full_text = crate::core::usecases::formatter::TextFormatter::wrap_thai_text(&chunk_text);
